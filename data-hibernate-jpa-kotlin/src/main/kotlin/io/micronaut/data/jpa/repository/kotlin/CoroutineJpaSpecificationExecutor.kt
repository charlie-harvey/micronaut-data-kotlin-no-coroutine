 ...
 */
package io.micronaut.data.jpa.repository.kotlin
...
interface CoroutineJpaSpecificationExecutor<T> {
     ...
     * @return never null.
     */
    suspend fun findOne(spec: Specification<T>?): T?
     ...
     * @return never null.
     */
    suspend fun findAll(spec: Specification<T>?): List<T>
     ...
     * @return never null.
     */
    suspend fun findAll(spec: Specification<T>?, pageable: Pageable): Page<T>
     ...
     * @return never null.
     */
    suspend fun findAll(spec: Specification<T>?, sort: Sort): List<T>
     ...
     */
    suspend fun count(spec: Specification<T>?): Long
}
