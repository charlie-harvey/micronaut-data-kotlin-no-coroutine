...
interface KotlinJpaSpecificationExecutor<T> {
    ...
    /**
     * Returns a single entity matching the given [QuerySpecification] or [T?] if none found.
     *
    ...
    /**
     * Returns a single entity matching the given [PredicateSpecification] or [T?] if none found.
     *
     * @param spec The query specification
     * @return optional found result
     */
